...
#------------------------- Helper Functions ------------------------#
def create_button(text, command, width=30, height=2, font=('Silver', 20, 'bold'), bg='white'):
...
def main():
    ...
    main_canvas.create_window(500, 400, anchor="n", window=create_button("Play", levelselect))
    main_canvas.create_window(500, 490, anchor="n", window=create_button("Leaderboard", show_leaderboard))
    main_canvas.create_window(500, 580, anchor="n", window=create_button("Exit", root.quit))
...
def show_leaderboard():
    ...
    for i, (level, level_scores) in enumerate(scores.items(), start=1):
        leaderboard_canvas.create_text(200 + (i - 1) * 300, 200, text=f"Level {level}", font=('Silver', 45, 'bold'), fill='white')
        for j, (username, score) in enumerate(level_scores):
            leaderboard_canvas.create_text(200 + (i - 1) * 300, 290 + j * 30, text=f"{j + 1}. {username}: {score}", font=('Silver', 20), fill='white')
...
def menu():
    ...
    menu_canvas.create_window(500, 400, anchor="n", window=create_button("Resume Level", resume_level))
    menu_canvas.create_window(500, 490, anchor="n", window=create_button("Main Menu", quit2main))
    menu_canvas.create_window(500, 580, anchor="n", window=create_button("Exit", root.quit))
...
def load_level(level_num, bg_image):
    ...
    level_canvas.create_window(875, 50, anchor="n", window=create_button("Menu", menu, width=10))
    level_canvas.create_window(800, 600, anchor="n", window=create_button("Finish Level", finishlevelbtn, width=20))
...
def lvlcomplete(score):
    ...
    lvlcomplete_canvas.create_window(500, 400, anchor="n", window=create_button("Resume Level", resume_level))
    lvlcomplete_canvas.create_window(500, 490, anchor="n", window=create_button("Main Menu", quit2lvlselect))
